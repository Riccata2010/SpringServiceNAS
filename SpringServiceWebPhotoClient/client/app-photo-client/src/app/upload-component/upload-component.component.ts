...
export class UploadComponentComponent implements OnInit, UploadCallback {
    ...
    prog_class: string = '';
    txt_num_file_choose: string = '';
    operation_txt: string = '';
    operation_interval: any = null;
    ...
    error(err: any): void {
        ...
        if (this.operation_interval) {
            clearInterval(this.operation_interval);
        }
        this.operation_txt = "";
    }
    ...
    selectFiles(event) {
        ...
        if (this.selected_files) {
            this.txt_num_file_choose = "Selected: " + this.selected_files.length + " File";
        }
    }
    ...
    uploadFiles_() {
        ...
        this.service.sendToServiceWorker("upload", list, false);
    }
        ...
        try {
            ...
            if (this.selected_files) {
                ...
                this.service.requestGet(BaseCommon.config.upload_url_ping, () => {
                    ...
                    this.operation_txt = "Operation is running";
                    this.operation_interval = setInterval(() => {
                        if (this.operation_txt.endsWith("...")) {
                            this.operation_txt = "Operation is running";
                        }
                        this.operation_txt += ".";
                    }, 1000);

                    this.service.createWorkers(list, this, skip);
